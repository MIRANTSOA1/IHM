...
<body class="animsition">
        ...
        <div class="page-container">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-striped table-hover text-center" id= "affichage_matiere">
				...
				<div class="modal-dialog modal-ms" role="document">
					<div class="modal-content">
						<div class="modal-header">
							<h3 class="modal-title" id="scrollmodalLabel">Ajouter une matière</h3>
						...
						<div class="modal-body">
                            <div class="card-body card-block">
                                <form id="ajout_matiere" method="post" class="">
                                    ...
                                    <!-- Séléction du coefficient -->
                                    <div class="form-group">
                                        <div class="input-group">
                                            <div class="input-group-addon">
                                                <i class="fa fa-percent"></i>
                                            </div>
                                            <input type="number" id="coefficient" name="coefficient" placeholder="Crédit" class="form-control">
                                        </div>
                                    </div>
            ...
            <div class="modal fade" id="scrollmodal_modif" tabindex="-1" role="dialog" aria-labelledby="scrollmodalLabel" aria-hidden="true" data-backdrop="static">
				<div class="modal-dialog modal-ms" role="document">
					<div class="modal-content">
						<div class="modal-header">
							<h3 class="modal-title" id="scrollmodalLabel">Modifier une matière</h3>
							<button type="button" class="close" data-dismiss="modal" aria-label="Close">
								<span aria-hidden="true">&times;</span>
							</button>
						</div>
						<div class="modal-body">
                            <div class="card-body card-block">
                                <form id="modifier_matiere" method="post" class="">
                                    <!-- Code matière -->
                                    <input type="text" id="matiere_cache" name="matiere_cache" style= 'display:none'>
                                    <select name="niveau_cache" id="niveau_cache" style= 'display:none'>
                                        <!-- <option selected="selected">Niveau</option> -->
                                        <option value="L1 GB">L1 GB</option>
                                                <option value="L1 IG">L1 IG</option>
                                                <option value="L1 ASR">L1 ASR</option>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" id="matiere_modif" name="matiere" placeholder="Matière" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="number" id="coefficient_modif" name="coefficient_modif" placeholder="Coefficient" class="form-control">
                                        </div>
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-danger" data-dismiss="modal">Annuler</button>
    ...
    <script src="../../controlleur/matiere.js"></script>
